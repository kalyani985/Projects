...
<title>Librarian's Create Item Page: List</title>
</head>
<body>
	<table border="1">
		<tr>
		...
		<c:forEach items="${ilist}" var="it" varStatus="i">
			<tr>
				...
				<td>
					<c:url var="iedit" value="/item/updateitem">
				...
				<td>
					<c:url var="ihistory" value="/item/show_ihistory">
						<c:param name="item_id" value="${it.item_id}" />
					</c:url> 
